...
public class ByTravelInCreditPage {
    ...
    public void validityYearCardError() {
        validityYearError.shouldBe(visible);
    }

    public void ownerCardError() {
        ownerCardError.shouldBe(visible);
    }
}
